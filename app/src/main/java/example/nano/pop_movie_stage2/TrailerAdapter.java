...
import example.nano.pop_movie_stage2.models.Trailer;
...
public class TrailerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            view = mInflater.inflate(R.layout.trailer_item_movie, parent, false);
        ...
        Picasso.get().load(yt_thumbnail_url).into(viewHolder.imageView);
